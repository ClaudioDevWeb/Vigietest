...
function getTechVideo($id=null,$searchDATA = array())
{
    ...
    elseif (!empty($searchDATA)) {
        ...
        if(!empty($service)) $search.=" AND service LIKE '%$service%'";
...
function getInc2($id=null,$searchDATA = array())
{
    if(!empty($id))
    {
    ...
    elseif (!empty($searchDATA)) {
        ...
        if(!empty($nbr_enfant)) $search.=" AND nbr_enfant=$nbr_enfant";
        if(!empty($service)) $search.=" AND service LIKE '%$service%'";
        $sql="SELECT * FROM incendie2 $search";
        $req = $GLOBALS['connexion']->prepare($sql);
        $req->execute();
        return $req->fetchAll();
    }
...
function getInc1($id=null,$searchDATA = array())
{
    if(!empty($id))
    {
    ...
    elseif (!empty($searchDATA)) {
        ...
        if(!empty($nbr_enfant)) $search.=" AND nbr_enfant=$nbr_enfant";
        if(!empty($service)) $search.=" AND service LIKE '%$service%'";
        $sql="SELECT * FROM incendie1 $search";
        $req = $GLOBALS['connexion']->prepare($sql);
        $req->execute();
        return $req->fetchAll();
    }
...
function getInt1($id=null,$searchDATA = array())
{
    if(!empty($id))
    {
    ...
    elseif (!empty($searchDATA)) {
        ...
        if(!empty($nbr_enfant)) $search.=" AND nbr_enfant=$nbr_enfant";
        if(!empty($service)) $search.=" AND service LIKE '%$service%'";
        $sql="SELECT * FROM intervention1 $search";
        $req = $GLOBALS['connexion']->prepare($sql);
        $req->execute();
        return $req->fetchAll();
    }
...
function getInt2($id=null,$searchDATA = array())
{
    if(!empty($id))
    {
    ...
    elseif (!empty($searchDATA)) {
        ...
        if(!empty($nbr_enfant)) $search.=" AND nbr_enfant=$nbr_enfant";
        if(!empty($service)) $search.=" AND service LIKE '%$service%'";
        $sql="SELECT * FROM intervention2 $search";
        $req = $GLOBALS['connexion']->prepare($sql);
        $req->execute();
        return $req->fetchAll();
    }
