...
!empty($_POST['id']))
{
$sql="UPDATE tls1 set matricule=?,nom=?,prenom=?,pseudo=?,numero_tel=?,numero_cin=?,date_embauche=?,adresse=?,situation_familial=?,nbr_enfant=?
WHERE id=?";
