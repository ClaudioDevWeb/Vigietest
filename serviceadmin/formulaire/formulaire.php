...
<div class="home-content">
    <div class="overview-boxes">
        ...
        <div class="box">
            <form action="<?=!empty($_GET['id'])?'model/modifTech.php':'model/ajoutTech.php'?>" method="post">
                ...
                <input  type="text" value='<?= !empty($_GET['id']) ? $article['num_tel'] : ""?>' name="num_tel" id="num_tel" placeholder="Veuillez entrez le numero tel">
                 
                <label for="num_cin">Numero CIN</label>
                <input  type="text" value='<?= !empty($_GET['id']) ? $article['num_cin'] : ""?>' name="num_cin" id="num_cin" placeholder="Veuillez entrez le numero cin">
                                             
                <label for="date_embauche">Date de l'ambauche</label>
                <input type="datetime-local" value='<?= !empty($_GET['id']) ? $article['date_embauche'] : ""?>' name="date_embauche" id="date_embauche">
                ...
                <input  type="number" value='<?= !empty($_GET['id']) ? $article['nbr_enfant'] : ""?>' name="nbr_enfant" id="nbr_enfant" placeholder="Veuillez entrez le nombre d'enfant">
