...
<h2>RAJOUT D'EQUIPE TECHNIQUE</h2>
    <div class="overview-boxes">
    
        <div class="box">
    <form action="ajouter_donnees.php" method="post">
       <label for="table">Technique</label>
        <select id="table" name="table">
            <option value="tech_video">technicien video</option>
            <option value="tech_alarme">technicien alarme</option>
        </select>
