                ...
                <table class="mtable">
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?=$value['service']?></td>
                                <td><a href="modifinc1.php?id=<?=$value['id']?>"><i class='bx bx-edit-alt'></i></a></td>
                                <td><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="suppresioninc1.php?id=<?=$value['id']?>">supprimer</a></td>
                            </tr>
