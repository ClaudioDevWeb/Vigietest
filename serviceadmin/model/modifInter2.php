...
!empty($_POST['id']))
{
$sql="UPDATE intervention2 set matricule=?,nom=?,prenom=?,pseudo=?,numero_tel=?,numero_cin=?,date_embauche=?,adresse=?,situation_familial=?,nbr_enfant=?,service=?
WHERE id=?";
$rq=$connexion->prepare($sql);

$rq->execute(array($_POST['matricule'],$_POST['nom'],$_POST['prenom'],$_POST['pseudo'],
$_POST['numero_tel'],$_POST['numero_cin'],$_POST['date_embauche'],$_POST['adresse'],$_POST['situation_familial'],$_POST['nbr_enfant'],$_POST['service'],$_POST['id']));
