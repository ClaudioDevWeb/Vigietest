...
if(!empty($_GET['id']))
$article=getInt1($_GET['id']);
?>
<div class="home-content">
    <div class="overview-boxes">
    
    <div style="display:block;" class="box">
    <h1>EQUIPE INTERVENTION 1</h1>
            ...
            <button type="submit">Valider</button> 
              ...
              <br>  
                <table class="mtable">
                    ...
                    <?php
                    if (!empty($_GET)) {
                        $int1=getInt1(null,$_GET);
                    }else{
                        $int1=getInt1();
                    }
                

                    if(!empty($int1) && is_array($int1))
                    {
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?=$value['service']?></td>
                                <td><a href="modifint1.php?id=<?=$value['id']?>"><i class='bx bx-edit-alt'></i></a></td>
                                <td><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="suppresioninter1.php?id=<?=$value['id']?>">supprimer</a></td>
                            </tr>
