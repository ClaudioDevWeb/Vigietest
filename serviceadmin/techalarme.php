                ...
                <tr>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?=$value['service']?></td>
                                <td><a href="modifalarme.php?id=<?=$value['id']?>"><i class='bx bx-edit-alt'></i></a></td>
                                <td><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="suppresionalarme.php?id=<?=$value['id']?>">supprimer</a></td>
                            </tr>
