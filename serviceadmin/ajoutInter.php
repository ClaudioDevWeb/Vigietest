<?php
include 'entete/enteteppl2.php';
?>

<div class="home-content">
<h2>RAJOUT D'EQUIPE INTERVENTION</h2>
    <div class="overview-boxes">
    
        <div class="box">
        
    <form action="ajouter_donnees.php" method="post">
        <label for="table">Intervention</label>
        <select id="table" name="table">
            <option value="intervention1">intervention1</option>
            <option value="intervention2">intervention2</option>
        </select>
