            ...
            <button type="submit">Valider</button> 
              ...
              <br>  
                <table class="mtable">
                    ...
                    <?php
                    if (!empty($_GET)) {
                        $tls2=getTls2(null,$_GET);
                    }else{
                        $tls2=getTls2();
                    }
            

                    if(!empty($tls2) && is_array($tls2))
                    {
                        foreach($tls2 as $key=>$value){
                    ?>
                            <tr>
                                ...
                                <td><?=$value['service']?></td>
                                <td><a href="modiftls2.php?id=<?=$value['id']?>"><i class='bx bx-edit-alt'></i></a></td>
                                <td><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="suppresiontls2.php?id=<?=$value['id']?>">supprimer</a></td>
                            </tr>
