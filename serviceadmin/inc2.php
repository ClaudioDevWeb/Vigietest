            ...
            <button type="submit">Valider</button> 
              ...
              <br>  
                <table class="mtable">
                    ...
                    <?php
                    if (!empty($_GET)) {
                        $inc2=getInc2(null,$_GET);
                    }else{
                        $inc2=getInc2();
                    }
                

                    if(!empty($inc2) && is_array($inc2))
                    {
                        foreach($inc2 as $key=>$value){
                    ?>
                            <tr>
                                ...
                                <td><?=$value['service']?></td>
                                <td><a href="modifinc2.php?id=<?=$value['id']?>"><i class='bx bx-edit-alt'></i></a></td>
                                <td><a onclick="return confirm('Etes vous sur de vouloir supprimer cette ligne?')" href="suppresioninc2.php?id=<?=$value['id']?>">supprimer</a></td>
                            </tr>
