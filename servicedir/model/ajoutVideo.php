...
{
$sql="INSERT INTO tech_video(matricule,nom,prenom,pseudo,numero_tel,numero_cin,date_embauche,adresse,situation_familial,nbr_enfant)
VALUES(?,?,?,?,?,?,?,?,?,?)";
...
header('Location:../ajoutTechVideo.php');
?>