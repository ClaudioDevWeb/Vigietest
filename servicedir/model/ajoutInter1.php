...
{
$sql="INSERT INTO Intervention1(matricule,nom,prenom,pseudo,numero_tel,numero_cin,date_embauche,adresse,situation_familial,nbr_enfant)
VALUES(?,?,?,?,?,?,?,?,?,?)";
...
header('Location:../ajoutInter1.php');
?>