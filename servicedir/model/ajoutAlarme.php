...
{
$sql="INSERT INTO tech_alarme(matricule,nom,prenom,pseudo,numero_tel,numero_cin,date_embauche,adresse,situation_familial,nbr_enfant)
VALUES(?,?,?,?,?,?,?,?,?,?)";
...
header('Location:../ajoutTechAlarme.php');
?>