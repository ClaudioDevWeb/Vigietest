...
$inc1Data = getInc1(null, $searchData);  // Appelle la fonction de recherche pour tech_video
$inc2Data = getInc2(null, $searchData);  // Appelle la fonction de recherche pour tech_alarme

// Fusionner les résultats des deux tables
$combinedData = array_merge($inc1Data, $inc2Data);
?>
<div class="home-content">
    <div class="overview-boxes">
        <div style="display:block;" class="box">
        <h1>LISTES INCENDIES</h1>
